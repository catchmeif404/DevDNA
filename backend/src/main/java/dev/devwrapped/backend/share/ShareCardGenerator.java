    ...
    public String generate(AnalysisResult result) {
        ...
        return """
                <svg xmlns="http://www.w3.org/2000/svg" width="600" height="800" viewBox="0 0 600 800">
                  ...
                  <text x="300" y="90" text-anchor="middle" font-family="system-ui, sans-serif" font-size="22" letter-spacing="6" fill="#a5b4fc">DEV DNA</text>
                  ...
                  <text x="300" y="750" text-anchor="middle" font-family="system-ui, sans-serif" font-size="16" letter-spacing="2" fill="#64748b">devdna.dev</text>
                </svg>
                """
